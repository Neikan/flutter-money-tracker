...
abstract class $AppCategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String color, bool isRequestToRemove});
}
...
class _$_AppCategory implements _AppCategory {
  ...
  @override
  String toString() {
    return 'AppCategory(id: $id, name: $name, color: $color, isRequestToRemove: $isRequestToRemove)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, color, isRequestToRemove);
...
abstract class _AppCategory implements AppCategory {
  const factory _AppCategory(
      ...
      final bool isRequestToRemove}) = _$_AppCategory;
